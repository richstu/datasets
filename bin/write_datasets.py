...
def are_arguments_valid(args):
  ...
  # Check for years
  if not argparse_helper.is_valid(args, 'years', ['2016', '2016APV', '2017', '2018', '2022', '2022EE', '2023']):
...
if __name__ == '__main__':
  ...
  parser.add_argument('-y', '--years', metavar='"2016,2016APV,2017,2018,2022,2022EE,2023"', nargs=1, default=['2016,2016APV,2017,2018,2022,2022EE,2023'])
