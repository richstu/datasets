...
def are_arguments_valid(args):
  ...
  # Check for years
  if not argparse_helper.is_valid(args, 'years', ['2016', '2016APV', '2017', '2018', '2022', '2022EE', '2023', '2023BPix']):
...
if __name__ == '__main__':
  ...
  parser.add_argument('-y', '--years', metavar='"2016,2016APV,2017,2018,2022,2022EE,2023,2023BPix"', nargs=1, default=['2016,2016APV,2017,2018,2022,2022EE,2023,2023BPix'])
  ...
  mc_dataset_2023_names_filename = meta_folder+'/mc_dataset_2023_names'
  mc_dataset_2023BPix_names_filename = meta_folder+'/mc_dataset_2023BPix_names'
  ...
  if make_mc_datasets:
    ...
    mc_dataset_names = datasets.parse_multiple_mc_dataset_names([
      ...
      [mc_dataset_2023_names_filename, ['2023']],
      [mc_dataset_2023BPix_names_filename, ['2023BPix']],
      ])
